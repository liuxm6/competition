var dgjc = [{
  ...
  "ans": "C",
  "opts": ["位能性恒转矩负载", "反抗性恒转矩负载", "泵类负载", "恒功率负载"]
}, {
  "type": 1,
  "title": "（ ）不属于直流电机的定子部分",
  "ans": "D",
  "opts": ["主磁极", "换向极", "电刷装置", "换向器"]
}, {
  "type": 1,
  "title": "（ ）的励磁绕组与电枢绕组串联，电枢电流也是励磁电流。",
  "ans": "A",
  "opts": ["串励直流电机", "他励直流电机", "并励直流电机", "复励直流电机"]
}, {
  "type": 1,
  "title": "他励直流电动机的空载损耗Po<\/sub>包括机械摩擦损耗Pm<\/sub>和（ ）。",
  "ans": "B",
  "opts": ["电磁功率", "铁损耗", "铜损耗", "附加损耗"]
}, {
  "type": 1,
  ...
  "ans": "B",
  "opts": ["能耗制动状态", "反接制动状态", "回馈制动状态。"]
}, {
  "type": 1,
  "title": "线绕式异步电动机在转子绕组中串变阻器起动，（ ）。",
  "ans": "B",
  "opts": ["起动电流减小，起动转矩减小", "起动电流减小，起动转矩增大", "起动电流增大，起动转矩减小", "起动电流增大，起动转矩增大"]
}, {
  "type": 1,
  "degree": 2,
  "title": "若要求三相异步电动机以高速稳定下放重物应采用哪种制动方法（ ）。",
  "ans": "B",
  "opts": ["能耗制动", "电源反接制动", "倒拉反接制动", "正向回馈制动"]
}, {
  "type": 1,
  "title": "当电动机的电磁转矩T大于负载转矩Tz<\/sub>时，说明电动机的转速变化率（ ）。",
  "ans": "A",
  "opts": ["大于0", "小于0", "等于0", "不能确定"]
}, {
  "type": 1,
  ...
  "ans": "C",
  "opts": ["升高", "下降一直到停转", "下降至零后再反向旋转", "下降到某一稳定转速"]
}, {
  "type": 1,
  "title": "与固有机械特性相比，人为机械特性上的最大电磁转矩减小，临界转差率没变，则该人为机械特性是异步电动机的：（ ）。",
  "ans": "C",
  ...
  "ans": "B",
  "opts": ["输入功率", "输出的机械功率", "电磁功率"]
}, {
  "type": 1,
  "title": "三相异步电动机(除风机负载外)要保持稳定运行，则转差率S应该（ ）。",
  "ans": "A",
  "opts": ["小于临界转差率", "等于临界转差率", "大于临界转差率"]
}, {
  "type": 1,
  ...
  "ans": "A",
  "opts": ["电枢绕组", "励磁绕组", "电枢绕组和励磁绕组"]
}, {
  "type": 1,
  "title": "三相异步电动机空载时，气隙磁通的大小主要取决于（ ）。",
  "ans": "A",
  "opts": ["电源电压", "气隙大小", "定、转子铁心材质", "定子绕组的漏阻抗"]
}];
